...
public class UserDaoJdbcImpl implements UsersDao {
    ...
    // language=SQL
    private static final String SQL_UPDATE_USER ="UPDATE group_member WHERE id =:id;";
    // language=SQL
    ...
    // language=SQL
    private static final String SQL_DELETE_USER ="DELETE FROM group_member WHERE id = :id;";
